'''IFES Campus Serra
EM Integrado em Informática para Internet, Progamação III - Alessandra Vilarinho
Feito em Fevereiro de 2025.
Autores: Ângelo dos Santos, Pedro Moraes, Alex Sorace
'''
...
def main():
    ...
    #fundo e fonte
    fundoimg = pygame.image.load('fundo1.png') 
    ...
    def centralizar_texto(texto, tamanho_tela):
        return texto.get_rect(center=(tamanho_tela[0] // 2, tamanho_tela[1] // 2)) # centraliza a posicao do título e subtítulo
    
    def escrita_fixa():
        fonte_grande = pygame.font.Font(None, 70)  # define uma fonte maior
        
        # renderiza título e subtítulo
        texto1 = fonte_grande.render('CRAMPS', True, cores['branco'])
        texto2 = fonte_grande.render('The ultimate gambling game', True, cores['branco'])
    ...
    # desenha as caixas de input e a borda que muda de cor    
    ...
    # desenha o lugar onde a pessoa deve clicar para rolar os dados (com borda também)    
    def desenha_botao_rolagem(dados, retangulo, ativo):
        cor_borda = cores['azul'] if ativo else cores['cinza']  
        pygame.draw.rect(tela, cores['branco'], retangulo)  
        pygame.draw.rect(tela, cor_borda, retangulo, 3)  
        texto_botao = fonte.render("Jogar dados", True, cores['preto'])  
        tela.blit(texto_botao, (retangulo.x + 17, retangulo.y + 20)) 
    ...
    def desenhar_area_dados(dados):
        ...
        pygame.draw.rect(tela, cores['branco'], (535, 230, 80, 80))  # primeiro dado
        pygame.draw.rect(tela, cores['branco'], (740, 230, 80, 80))  # segundo dado
        
    # desenha o orçamento na tela
    ...
    # desenha a mensagem de aviso que aparece no jogo
    ...
    botao_rolagem = pygame.Rect(600, 330, 155, 60)
    texto_aposta = ''
    texto_numero = ''
            ...
            if evento.type == pygame.QUIT:  
                ...
                if caixa_aposta.collidepoint(evento.pos):  
                    ...
                    if texto_aposta.isdigit() and texto_numero.isdigit():
                        ...
                        elif aposta > orcamento and aposta > 0:
                            mensagem = "Você faliu!"
                        else:
